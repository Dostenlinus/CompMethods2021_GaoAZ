...
\input{./econtexRoot}
\externaldocument{\LaTeXGenerated/ProjectGAZ} % Get xrefs -- esp to appendix -- from main file; only works properly if main file has already been compiled;
